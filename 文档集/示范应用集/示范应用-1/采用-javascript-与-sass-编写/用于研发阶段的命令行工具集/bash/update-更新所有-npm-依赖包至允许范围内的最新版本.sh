...
function 完整流程 {
    ...
    Update-吴乐川更新当前_npm_项目的所有依赖包 \
        --某产品级依赖包之版本配置 "                                    core-js   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                                    echarts   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                                        vue   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                                 vue-router   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                                @babel/core   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                       @babel/eslint-parser   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                      @vue/cli-plugin-babel   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                     @vue/cli-plugin-eslint   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                     @vue/cli-plugin-router   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                           @vue/cli-service   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                @vue/eslint-config-standard   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "@wulechuan/cli-scripts--npm-project-helpers   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                                     eslint   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                       eslint-plugin-import   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                         eslint-plugin-node   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                      eslint-plugin-promise   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                          eslint-plugin-vue   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                                       sass   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                                sass-loader   |:|   latest   |:|" \
        --某研发级依赖包之版本配置 "                      vue-template-compiler   |:|   latest   |:|" \
        --内容分割记号='|:|' \
        --NPM安装依赖包时须额外带上的参数序列="$NpmArguments" \
        --调试功能之级别 0 \
        --应仅作仿真演练 false
