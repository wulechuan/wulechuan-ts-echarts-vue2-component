<template>
    <div class="page-with-an-echart">
        <h2>下方图表之源代码中引入的是 the-wrapper-only.vue，其中的脚本块采用 JavaScript 书写。</h2>
        <p>{{ message }}</p>
...
import EChartsVue2Component from '@wulechuan/echarts-vue2-component/javascript/the-wrapper-only.vue'
